...
export default function FoodCheckPage() {
  ...
  function selectFood(food: Food) {
    ...
    // On mobile the nutrition panel sits below the results, so move the
    // user straight to it after selection. On desktop it is already visible
    // beside the search/results column, so do not move the page.
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <div className="mx-auto max-w-[1500px] px-4 py-5 lg:px-8 lg:py-6">
        ...
        <section className="grid gap-5 lg:grid-cols-2">
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-green-100 bg-white shadow-sm">
            ...
            {/* Card content */}
            <div className="relative z-10 px-6 py-6 sm:px-8 sm:py-7 lg:px-9">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={searching}
                  className="h-14 shrink-0 rounded-2xl bg-green-600 px-6 font-bold text-white shadow-sm transition hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {searching
                    ? "Searching..."
                    : "Search"}
            ...
            <div className="border-b border-slate-200 px-6 py-5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                ...
                {search.trim()
                  ...
                  : "Enter a food above to search the database."}
        ...
        >
          ...
          <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
            ...
            {!selectedFood ? (
              ...
              <div className="flex min-h-[300px] items-center justify-center px-8 text-center">
                ...
                <div className="max-w-md">
                  ...
                  <p className="mt-2 leading-6 text-slate-600">
                    Search the CoFID 2021 database
                    and select a food to see its
              ...
              <>
                ...
                <div className="border-b border-slate-200 p-6">
                  ...
                  <div className="flex flex-col gap-5 sm:flex-row">
                    ...
                    <div className="flex h-32 w-full shrink-0 items-center justify-center rounded-2xl bg-green-50 text-6xl sm:w-44">
                      🍽️
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-col justify-between gap-4 sm:flex-row">
                        ...
                        <div className="h-fit shrink-0 rounded-xl bg-blue-50 px-4 py-3 text-sm">
