...
},
{
...

  {
    ...
    ingredients: [
      { item: "Chicken breast, skinless", shoppingItem: "Chicken breast", quantity: "4 Ã— 150g" },
      ...
      { item: "Garlic granules", quantity: "Â½ tsp" },
    ...
    method: [
      ...
      "Fluff the couscous with a fork and stir through 1Â½ tbsp of the olive oil, the lemon zest, half the lemon juice and the dried herbs.",
  ...
  },
  {
    ...
    ingredients: [
      { item: "Chicken breast, skinless", shoppingItem: "Chicken breast", quantity: "4 Ã— 140g" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { item: "Garlic granules", quantity: "Â½ tsp" },
      { item: "Ground ginger", quantity: "Â½ tsp" },
      { item: "Black pepper", quantity: "To taste" },
      { item: "Fresh parsley", quantity: "Small handful" },
      { item: "No added salt", quantity: "As required" },
    ],
    method: [
      ...
      "Cook the basmati rice according to the packet instructions.",
      "Heat 1 tbsp of the olive oil in a large frying pan and cook the onion, pepper and courgette for 5â€“6 minutes. Remove and keep warm.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      { item: "Olive oil", quantity: "2 tbsp" },
      { item: "Lemon juice", shoppingItem: "Lemon", quantity: "Â½ lemon" },
      { item: "Dried oregano", quantity: "1 tsp" },
      { item: "Garlic granules", quantity: "Â½ tsp" },
      { item: "Black pepper", quantity: "To taste" },
    ...
    method: [
      ...
      "Heat 1 tbsp of the olive oil in a large frying pan and cook the chicken for 7â€“8 minutes, turning regularly, until completely cooked through.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      { item: "Half-fat crÃ¨me fraÃ®che", quantity: "150ml" },
      { item: "Olive oil", quantity: "2 tbsp" },
      { item: "Paprika", quantity: "1 tsp" },
  ...
  },
  {
    ...
    ingredients: [
      { item: "Lean sirloin steaks", shoppingItem: "Sirloin steak", quantity: "4 Ã— 150g" },
    ...
    method: [
      ...
      "Heat 2 tbsp olive oil in a large frying pan and cook the chips over a medium heat for 15â€“20 minutes, turning regularly, until golden and cooked through.",
  ...
  },
  {
    ...
    ingredients: [
      { item: "Lean pork loin steaks", shoppingItem: "Pork loin steaks", quantity: "4 Ã— 150g" },
    ...
    method: [
      ...
      "Heat 1 tbsp olive oil in a large frying pan. Season the pork with black pepper and sage and cook for 4â€“5 minutes per side, until cooked through. Remove and keep warm.",
  ...
  },
  {
    ...
    method: [
      ...
      "Heat 1Â½ tbsp olive oil in a large frying pan or wok over a high heat.",
  ...
  },
  {
    ...
    equipment:
      "Large saucepan, large frying pan, steamer or saucepan for green beans, chopping board, knife",
    ingredients: [
      { item: "Cod fillets", shoppingItem: "Cod fillets", quantity: "4 Ã— 170g" },
      { item: "Potatoes", shoppingItem: "Potatoes", quantity: "800g" },
  ...
  },
  {
    ...
    method: [
      "Heat 1 tbsp olive oil in a large frying pan and gently cook the onion, pepper and courgette for 5â€“6 minutes.",
